...
public class MapSocio extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void disconect(){
        ...
        if(mFusedLocation != null){
            ...
            Toast.makeText(MapSocio.this, "No te puedes desconectar", Toast.LENGTH_SHORT).show();
        }
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(MapSocio.this, new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        })
                        .create()
                        .show();
    ...
    void logout(){
        ...
        Intent intent = new Intent(MapSocio.this, MainActivity.class);
